...
namespace Sistema_Inventarios_DAL.DBContext;
...
public partial class TiendaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CFB5B3240");
        ...
        {
            entity.HasKey(e => e.IdCompra).HasName("PK__Compra__48B99DB7029A3D39");
        ...
        {
            entity.HasKey(e => e.IdDetalleCompra).HasName("PK__DetalleC__62C252C1352412C2");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F88791781");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4837A025F60");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4F697DADA");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421AA8E136C7");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1329DE9CD3D");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76D5FCD8FD");
        ...
        {
            entity.HasKey(e => e.IdSku).HasName("PK__Sku__024FBA3F3155C3B6");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A60752F55E");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561409E443B7");
